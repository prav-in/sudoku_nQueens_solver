...
const Main = () => {
  ...
  return (
    <div className={styles.main}>
      <button className={styles.btn} onClick={clearSudoku}>Clear</button>
          <Grid data={data} setData={setData} isSafe={isSafe} />
    <button className={styles.btn} onClick={solveSudoku}>Solve</button>  
    </div>
  )
}
